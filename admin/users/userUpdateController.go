...
// 			links.NewWebsiteLinks().Resource(`/js/blockarea_v0200.js`, map[string]string{}),
// 		},
// 		Scripts: []string{
// 			controller.script(),
// 		},
...
// 	err := config.UserStore.UserUpdate(context.Background(), data.user)
...
// 	user, err := config.UserStore.UserFindByID(context.Background(), data.userID)
